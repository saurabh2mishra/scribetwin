...
def extract_style_features(text: str) -> Dict[str, Any]:
    ...
    features = {
        ...
        # Tone indicators
        'uses_contractions': any(word in text.lower() for word in ["don't", "can't", "won't", "it's", "you're", "we're"]),
...
def select_diverse_examples(text: str, num_examples: int = 3, min_length: int = 500) -> List[str]:
